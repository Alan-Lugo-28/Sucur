...
(function(global, factory) {
    ...
    jQuery.extend({
        ...
        expando: "jQuery" + (version + window.crypto.getRandomValues(new Uint32Array(1))).replace(/\D/g, ""),
                ...
                var bySet = setMatchers.length > 0,
                    ...
                    superMatcher = function(seed, context, xml, results, outermost) {
                        var elem, j, matcher,
                            ...
                            dirrunsUnique = (dirruns += contextBackup == null ? 1 : window.crypto.getRandomValues(new Uint32Array(1)) || 0.1),
                            len = elems.length;
